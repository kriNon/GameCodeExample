...
#include "ArrowMovementComponent.generated.h"
...
class OWSPLUGIN_API UArrowMovementComponent : public UMovementComponent
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Projectile)
	float ProjectileNoGravityRange;
...
public:
	...
	bool ShouldArrowApplyGravity() const;
